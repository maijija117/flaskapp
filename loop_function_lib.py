...
def loop_function():
  while True:
    ...
    if current_time.hour == 0 and current_time.minute == 1 and current_time.day == 1:
      print(
        timestamp +
        "It is the first day of the month at 00:01. Ready to refill token!")
      y = 25000
      # Continue with the next process
      filter_criteria = {}
      update_operation = {'$set': {'freetoken': y}}
